...
const ChatBox = () => {
    return (
        <>
            <div className="chat-box h-[86.3vh] relative bg-gradient-to-b from-gray-800 via-gray-900 to-black text-white border-l">
                <div className="chat-user flex items-center gap-[10px] py-3 px-[15px] border-b border-[#c6c6c6]">
