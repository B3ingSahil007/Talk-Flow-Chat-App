...
const RightSideBar = () => {
    return (
        <>
            <div className='rs flex flex-col items-center bg-gradient-to-b from-gray-800 via-gray-900 to-black text-white h-[100%] p-4 space-y-6 border-l'>
                ...
                <button className='btn btn-outline-dark text-white border px-4 py-2 rounded-lg'>
                    Log-Out
                </button>
            </div>
